...
parser = argparse.ArgumentParser(description='TFE-DCN')
parser.add_argument('--path-dataset', type=str, default='/dataset/Thumos14/', help='the path of data feature')
...
parser.add_argument('--model-name', default='TFEDCN_1', help='name to save model')
...
parser.add_argument('--max-iter', type=int, default=6010, help='maximum iteration to train (default: 50000)')
...
parser.add_argument("--alpha4", type=float, default=3)

parser.add_argument("--AWM", type=str, default='Modality_Enhancement_Module')
parser.add_argument("--OPT", type=str, default='Optical_convolution')
